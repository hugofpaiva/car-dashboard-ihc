...
for(i=0; i<recentcalls.length;i++){
    ...
    row.style = "width: 100%; height:15%; display: flex; justify-content: space-evenly; flex-direction: row;"

    var div1 = document.createElement("div")
    div1.style = "width: 40%;"

    var div2 = document.createElement("div")
    div2.style = "width: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center;"
...
function showContacts(element) {
    ...
    if(letter_contacts.length==0){
        var row = document.createElement("div")
        row.style = "width: 70%; height:15%; display: flex; justify-content: center; flex-direction: row; padding-top: 20px"
        ...
        div4.style = "width: 25%; height:15%; display: flex; justify-content: center; align-items: center; padding-top: 20px"
    ...
    for(i=0; i<letter_contacts.length;i++){
        var row = document.createElement("div")
        row.style = "width: 70%; height:15%; display: flex; justify-content: space-evenly; flex-direction: row; padding-top: 20px"
